				...
				error : function(html) {
					console.log("error html:" + html);
						...
						<select name="domain_name" id="domain_name" class="form-control" onchange="getDomains()"
							>
							<option> <%String User = (String) request.getAttribute("User"); 
			
			if(User != null) {
				%>
				<%=User %>
				<%}
			else{ %> <%="Select Robot" %><%} %></option>
				...
				error : function(html) {
					console.log("error html:" + html);
						...
						<select name="package" id="package" class="form-control"
							onchange="getRobots()" >
							<option><%String packageID = (String) request.getAttribute("packageID"); 
			
			if(packageID != null) {
				%>
				<%=packageID %>
				<%}
			else{ %> <%="Select Package" %><%} %></option>
						...
						<select name="displayrobots" id="displayrobots" onchange="RobotNames(this.value);"
							class="form-control" >
							<option><%String robotID = (String) request.getAttribute("robotID"); 
