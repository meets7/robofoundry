				...
				if(ToTenantPermission != null){
					for(int j =0; j < ToTenantPermission.size(); j++){
						...
						try{
							...
							int rs = statement
									.executeUpdate("INSERT INTO  Role.Inter_Tenant_Mapping (FromTenantID ,FromPackagePermissionID ,ToTenantID ,ToPackagePermissionID)VALUES (" + "'" + FromTenantID.get(0) + "'" +  "," +  "'" + FromPackagePermissionID.get(0) + "'" + "," + "'" + role_values[0] + "'" + "," + "'" + role_values[1] + "'" + ")");
							if(rs > 0)
							{
